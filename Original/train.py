import argparse
import os
os.environ['PYTHONFAULTHANDLER'] = 'x'
...
# dist.init_process_group(backend='nccl', init_method='env://', rank = 1, world_size = 2)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--config', default="/home/diani/diani/CWSAM-master-original/configs/my_dataset/cdw_no_w.yaml")
